 ...
 */
class ServerTypeForm extends ContentEntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    /*$entity = $this->entity;
    if(!$entity->isNew() && $entity->get('server_number')->value != 0) {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('Server catalog saved successfully'));
